...
tracker1 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_not_quant_eval_GPTQ.csv")
wandb.init(project="prueba_GPTQ", name="not_quant")
