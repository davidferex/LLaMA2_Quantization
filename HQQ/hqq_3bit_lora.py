...
tracker1 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_3bit_quant_batch64_HQQ_LORA.csv", gpu_ids=[0])
tracker2 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_3bit_eval_batch64_HQQ_LORA.csv", gpu_ids=[0])

wandb.init(project="HQQ_Lora", name="3bit_batch64")
...
# Mostrar resultados
print(f"Modelo LoRA cuantizado gptq 3bit - Tiempo de inferencia: {time_no:.2f}s")
