...
tracker1 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_3bit_quant_batch64_GPTQ_LORA.csv", gpu_ids=[0])
tracker2 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_3bit_eval_batch64_GPTQ_LORA.csv", gpu_ids=[0])

wandb.init(project="GPTQ_Lora", name="3bit_batch64")
