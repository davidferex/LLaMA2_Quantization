...
tracker1 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_4bit_batch64_quant_GPTQ.csv", gpu_ids=[0])
tracker2 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_4bit_batch64_eval_GPTQ.csv", gpu_ids=[0])
wandb.init(project="GPTQ", name="4bit_batch64")
...
def evaluate_model(model, tokenizer, dataset, quant, batch_size=64):
    model.eval()
    correct = 0
    total = 0
