...
tracker1 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_4bit_quant_batch64_ByB_LORA.csv", gpu_ids=[0])
tracker2 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_4bit_eval_batch64_ByB_LORA.csv", gpu_ids=[0])
...
# Mostrar resultados
print(f"Modelo LoRA cuantizado byb 4bit - Tiempo de inferencia: {time_no:.2f}s")
