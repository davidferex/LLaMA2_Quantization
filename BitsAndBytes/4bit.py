...
tracker1 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_4bit_quant_ByB.csv")
tracker2 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_4bit_eval_ByB.csv")
wandb.init(project="ByB", name="4bit")
...
tracker2.start()
accuracy_quantized, time_quantized, max_memory = evaluate_model(model_quantized, tokenizer, dataset, "quant")
tracker2.stop()
# Mostrar resultados
