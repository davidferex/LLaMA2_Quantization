...
tracker1 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_not_quant_batch64_eval_LORA.csv", gpu_ids=[1])
#tracker2 = OfflineEmissionsTracker(country_iso_code="ESP", allow_multiple_runs = True, output_file= "./emissions_8bit_eval_ByB_LORA.csv", gpu_ids=[0])

wandb.init(project="ByB_Lora", name="not_quant_batch64")
